  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-5 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-[10%] w-2 h-2 bg-primary/30 rounded-full animate-float" style={{ animationDelay: "0s" }} />
        <div className="absolute top-1/3 right-[15%] w-3 h-3 bg-accent/40 rounded-full animate-float" style={{ animationDelay: "0.5s" }} />
        <div className="absolute bottom-1/3 left-[20%] w-2 h-2 bg-primary/20 rounded-full animate-float" style={{ animationDelay: "1s" }} />
        <div className="absolute top-[60%] right-[25%] w-2 h-2 bg-accent/30 rounded-full animate-float" style={{ animationDelay: "1.5s" }} />
        <div className="absolute top-[20%] right-[10%] w-1.5 h-1.5 bg-primary/40 rounded-full animate-pulse-soft" style={{ animationDelay: "0.3s" }} />
        <div className="absolute bottom-[40%] right-[30%] w-1 h-1 bg-accent/50 rounded-full animate-pulse-soft" style={{ animationDelay: "0.7s" }} />
      </div>
